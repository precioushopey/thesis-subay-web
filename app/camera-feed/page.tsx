...
const CameraFeedPage = () => {
  return (
    <div className="relative w-full h-full p-4 -mt-4 font-[family-name:var(--font-prompt)] selection:bg-[#7F25FB] selection:text-white">
      <div className="h-full flex flex-col bg-[#0B1739] rounded-md p-4">
