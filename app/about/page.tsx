...
const AboutPage = () => {
  return (
    <div className="w-full h-full flex flex-col sm:flex-row gap-4 p-4 -mt-4 font-[family-name:var(--font-prompt)] selection:bg-[var(--purple)] selection:text-white">
      {/* LEFT */}
      <div className="w-full lg:w-1/2 h-auto flex flex-col gap-4">
        {/* ABOUT US */}
        <div className=" sm:h-2/3 h-auto w-full flex flex-col bg-[var(--card)] rounded-md p-4 cursor-pointer">
        ...
        {/* SUBAY */}
        <div className="sm:h-1/3 h-auto w-full flex flex-col bg-[var(--card)] rounded-md p-4 cursor-pointer">
          <h1 className="font-semibold text-base pb-2">Abstract</h1>
          <p className="text-xs text-[var(--gray)] text-wrap">
      ...
      <div className="w-full lg:w-1/2 h-auto flex flex-col gap-4">
        ...
        <div className="w-full h-auto sm:h-2/3 flex flex-col gap-4">
          ...
          <div className="w-full h-auto sm:h-1/2 flex flex-col sm:flex-row gap-4 overflow-hidden">
            {/* Xyrus */}
            <div className="relative h-auto w-full sm:w-1/2 flex flex-col sm:flex-row sm:justify-between bg-[var(--card)] rounded-md overflow-hidden cursor-pointer">
              <a
                href="#"
                target="_blank"
                className="absolute top-2 right-2 sm:left-2 hover:text-[var(--purple)]"
              >
                <MdFileOpen />
              </a>
              <div className="w-auto sm:w-1/2 items-center justify-center flex flex-col overflow-hidden">
                ...
                <div className="h-3/4 rounded-tr-full rounded-tl-full content-end bg-gradient-to-br from-[var(--pink)] to-[var(--purple)]">
                  <Image
                    src={"/xyrus.png"}
              ...
              <div className="flex flex-col place-content-between w-full sm:w-1/2 text-[var(--gray)] p-2">
                <h1 className="text-white text-[10px] text-center sm:text-left font-normal sm:border-l-2 sm:border-[var(--purple)] sm:pl-2">
                  Lead Researcher • Machine Learning Researcher
                </h1>
                <h1 className="text-[var(--gray)] text-[10px] text-center font-normal italic">
                ...
                <ul className="flex flex-row flex-wrap sm:flex-col justify-center sm:justify-start gap-x-4 sm:gap-0 text-[10px] font-light text-white">
                  <li className="flex flex-row items-center gap-1">
                    <MdEmail className="text-[var(--purple)] text-xs" />
                    <a
                      href="mailto:dominguez.xyrusvincent1@gmail.com"
                      target="_blank"
                      className="hover:text-[var(--purple)] flex flex-col"
                    >
                      <p>xyrus@gmail.com</p>
                    </a>
                  </li>
                  <li className="flex flex-row items-center gap-1">
                    <MdFacebook className="text-[var(--purple)] text-xs" />
                    <a
                  ...
                  <li className="flex flex-row items-center gap-1">
                    <AiFillInstagram className="text-[var(--purple)] text-xs" />
                    <a
            ...
            {/* Precious */}
            <div className="relative h-auto w-full sm:w-1/2 flex flex-col-reverse sm:flex-row sm:justify-between bg-[var(--card)] rounded-md cursor-pointer">
              <a
                href="https://drive.google.com/file/d/1Ht0vyHKKtTYDkNvNKNMpTn9Ppy886jza/view?usp=sharing"
                target="_blank"
                className="absolute top-2 right-2 hover:text-[var(--pink)]"
              >
                <MdFileOpen />
              </a>
              <div className="w-full sm:w-1/2 flex flex-col place-content-between text-[var(--gray)] text-right p-2">
                <h1 className="text-white text-[10px] text-center sm:text-right font-normal sm:border-r-2 sm:border-[var(--pink)] sm:pr-2">
                ...
                <ul className="flex flex-row flex-wrap sm:flex-col justify-center sm:items-end gap-x-4 sm:gap-0 text-[10px] font-light text-white">
                  <li className="flex flex-row-reverse sm:flex-row items-center gap-1">
                    <a
                      ...
                      target="_blank"
                      className="hover:text-[var(--pink)] flex flex-col"
                    >
                      <p>precious@gmail.com</p>
                    </a>
                    <MdEmail className="text-[var(--pink)] text-xs" />
                  </li>
                  <li className="flex flex-row-reverse sm:flex-row items-center gap-1">
                    <a
                    ...
                    <MdFacebook className="text-[var(--pink)] text-xs" />
                  </li>
                  <li className="flex flex-row-reverse sm:flex-row items-center gap-1">
                    <a
                    ...
                    <AiFillInstagram className="text-[var(--pink)] text-xs" />
                  </li>
                </ul>
              </div>
              <div className="w-auto sm:w-1/2 items-center justify-center flex flex-col overflow-hidden">
                ...
                <div className="h-3/4 rounded-tr-full rounded-tl-full content-end bg-gradient-to-bl from-[var(--purple)] to-[var(--pink)]">
                  <Image
                    src={"/precious.png"}
          ...
          <div className="w-full h-auto sm:h-1/2 flex flex-col sm:flex-row gap-4 overflow-hidden">
            ...
            <div className="relative h-auto w-full sm:w-1/2 flex flex-col sm:flex-row sm:justify-between bg-[var(--card)] rounded-md overflow-hidden cursor-pointer">
              <a
                href="#"
                target="_blank"
                className="absolute top-2 right-2 sm:left-2 hover:text-[var(--pink)]"
              >
                <MdFileOpen />
              </a>
              <div className="w-auto sm:w-1/2 items-center justify-center flex flex-col overflow-hidden">
                ...
                <div className="h-3/4 rounded-tr-full rounded-tl-full content-end bg-gradient-to-br from-[var(--purple)] to-[var(--pink)]">
                  <Image
                    src={"/rezzelle.png"}
              ...
              <div className="flex flex-col place-content-between w-full sm:w-1/2 text-[var(--gray)] p-2">
                <span className="text-white text-[10px] text-center sm:text-left font-normal sm:border-l-2 sm:border-[var(--pink)] sm:pl-2">
            ...
            <div className="relative h-auto w-full sm:w-1/2 flex flex-col-reverse sm:flex-row sm:justify-between bg-[var(--card)] rounded-md cursor-pointer">
              <a
                href="#"
                target="_blank"
                className="absolute top-2 right-2 hover:text-[var(--purple)]"
              >
                <MdFileOpen />
              </a>
              <div className="w-full sm:w-1/2 flex flex-col place-content-between text-[var(--gray)] text-right p-2">
                <h1 className="text-white text-[10px] text-center sm:text-right font-normal sm:border-r-2 sm:border-[var(--purple)] sm:pr-2">
              ...
              <div className="w-auto sm:w-1/2 items-center justify-center flex flex-col overflow-hidden">
                ...
                <div className="h-3/4 rounded-tr-full rounded-tl-full content-end bg-gradient-to-bl from-[var(--pink)] to-[var(--purple)]">
                  <Image
                    src={"/venz.png"}
        ...
        {/* Files */}
        <div className="sm:h-1/3 h-auto w-full flex flex-col bg-[var(--card)] rounded-md text-[var(--gray)] p-4 overflow-x-auto cursor-pointer">
